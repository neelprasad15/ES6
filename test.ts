...
let restOperator = function(a:any, b:any, ...c:any){
...
let spreadOperator = [3, 5, 1];
console.log( Math.max(...spreadOperator) ); // 5 (spread turns array into a list of arguments)
...
function objLit(firstName:any, lastName:any){
let fullName = `${firstName} ${lastName}`;
return {firstName,lastName,fullName}
}

let p = objLit("Neel", "Prasad")
